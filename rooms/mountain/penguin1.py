...
def scripts(player):
    ...
    io.narr("You hear squawks from the crowd, and you realize that they're Pinkos.")
    ...
    io.dialogue("Emperor Pinko", "Hey! Stop laughing! I'm your captain!")
    ...
    if escapetactic == "Tiptoe past him like a coward":
        ...
        io.narr("You run past Emperor Pinko like the cool person you are.")
        io.dialogue("Emperor Pinko", "HEY! YOU CAN'T JUST-")
